...
def get_args_hallucinate():
    ...
    parser.add_argument("--trrosetta=",  type=str, required=False, dest='TRDIR', default="saved_model/rosetta/model.xaa.pt&saved_model/rosetta/model.xab.pt&saved_model/rosetta/model.xac.pt&saved_model/rosetta/model.xad.pt&saved_model/rosetta/model.xae.pt",
                        help="path to trRosetta network weights")
    parser.add_argument("--background=", type=str, required=False, dest='BKDIR', default="saved_model/bkgrd/bkgrd.xaa.pt",
